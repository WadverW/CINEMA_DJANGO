...
#     image = models.ImageField(upload_to="img/pages/gallery/")
#     main_image = models.ImageField(upload_to="img/pages/main/", blank=True, null=True)


# class BannerImage(models.Model):
#     banner = models.ForeignKey(Banner, on_delete=models.CASCADE, related_name="images")
#     image = models.ImageField(upload_to="img/banners/gallery/")
#     bg_image = models.ImageField(
#         upload_to="img/banners/background/", blank=True, null=True
#     )
#     upper_image = models.ImageField(
#         upload_to="img/banners/upper/", blank=True, null=True
#     )


# class PromoImage(models.Model):
#     promotion = models.ForeignKey(
#         Promotion, on_delete=models.CASCADE, related_name="images"
#     )
#     image = models.ImageField(upload_to="img/promo/gallery/")
#     main_image = models.ImageField(upload_to="img/promo/main/", blank=True, null=True)
